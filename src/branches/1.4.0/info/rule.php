...
<h2><a id="worning">ゲームに参加する上で重要なこと</a></h2>
<div class="info">
...
<h2><a id="rule">「汝は人狼なりや？」の基本ルールについて</a></h2>
<ul>
...
<h3><a id="rule_purpose">[ゲームの目的]</a></h3>
<div class="info">
...
<h3><a id="rule_cast">[村人の人口推移]</a></h3>
<div class="info">
...
<h2><a id="system">WEB用スクリプトのシステム</a></h2>
<ul>
...
<h3><a id="system_night">[夜の行動]</a></h3>
<div class="info">
...
<h3><a id="system_date">[昼の集会所や夜の時間経過について]</a></h3>
<div class="info">
...
<h3><a id="system_time">[消費される時間について]</a></h3>
<h4>リアルタイム制の場合</h4>
<div class="info">
...
<h3><a id="system_vote">[投票について]</a></h3>
<h4>昼の処刑投票</h4>
<div class="info">
...
<h3><a id="system_sudden_death">[制限時間が過ぎると・・・]</a></h3>
<div class="info">
...
<h3><a id="system_last_words">[遺言とは]</a></h3>
<div class="info">
...
<h3><a id="display_main">[ゲーム前・生存中・ゲーム後]</a></h3>
<div class="info">
...
<h3><a id="display_role">実際に表示される「自分の役割（と能力の結果）」</a></h3>
<br>
<table class="role">
<tr><th>役割</th><th>--　　　　自分の役割(と能力の結果)　　　　--</th></tr>

<tr><td>村人</td><?php echo $ROLE_IMG->Generate('human', '村人', true) ?></tr>
...
<tr><td class="wolf">狂人</td><?php echo $ROLE_IMG->Generate('mad', '狂人', true) ?></tr>
...
<tr><td class="poison">埋毒者</td><?php echo $ROLE_IMG->Generate('poison', '埋毒者', true) ?></tr>
...
<tr><td>決定者</td><td>--なし--</td></tr>

<tr><td>権力者</td><?php echo $ROLE_IMG->Generate('authority', '権力者', true) ?></tr>
...
<h3><a id="display_dead">[ゲーム中に死亡すると]</a></h3>
<div class="info">
