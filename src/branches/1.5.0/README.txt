------------------------------------------------------------------------------
  人狼式 ～汝は人狼なりや？式神エディション Version 1.5.6 README 2013/04/16
------------------------------------------------------------------------------
...
1. server_config.php : 本スクリプトをサーバ上で動作させるための設定ファイル
2. game_config.php   : 村立て、制限時間など、ゲームプレイパラメータの設定ファイル
3. cast_config.php   : 配役設定ファイル
4. message.php       : ゲーム中で表示されるシステムメッセージの設定ファイル
5. version.php       : トップページで表示されるバージョン情報の設定ファイル

このうち、必ず設定が必要になるのは server_config.php のみです。
