...
$RQ_ARGS->TestItems->test_users[2]->role = 'wolf authority';
...
$RQ_ARGS->TestItems->test_users[4]->role = 'mage lovers[16] challenge_lovers rebel';
...
$RQ_ARGS->TestItems->test_users[13]->role = 'wolf mind_presage[23] copied_basic';
...
$RQ_ARGS->TestItems->test_users[19]->role = 'shadow_fairy psycho_infected';
...
$RQ_ARGS->TestItems->test_users[21]->role = 'revive_mania[6] mind_friend[21] panelist';
...
$RQ_ARGS->TestItems->vote->night = array(
  ...
  array('user_no' => 4, 	'target_no' => 13,	'type' => 'MAGE_DO'),
