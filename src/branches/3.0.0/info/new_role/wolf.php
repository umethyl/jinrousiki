...
<a href="#wolf_eat_failed">襲撃失敗表示</a>
</p>
<p>
...
<ol>
<li>村に紛れ込み、村人達を喰い殺そうと目論みます。</li>
<li>狂人は人狼の協力者です。</li>
</ol>

<h3 id="rule_win">勝利条件</h3>
<ol>
<li>生存カウントの村人の生存数を人狼の生存数以下にする。</li>
<li><a href="fox.php">妖狐</a>・<a href="lovers.php">恋人</a>を全滅させる。</li>
...
<ol>
  ...
  <li><a href="ability.php#sacrifice">身代わり能力</a> (例：<a href="human.php#doll_rule_doll_master">人形遣い系</a>・<a href="chiroptera.php#boss_chiroptera">大蝙蝠</a>) が先に適用され、失敗扱いとなる。</li>
...
<h2 id="wolf_eat_failed">襲撃失敗表示 [Ver. 3.0.0 α6～]</h2>
<ol>
  <li>人狼の襲撃が失敗した場合、死亡者メッセージ欄に失敗した理由が表示される。</li>
  <li>閲覧できるのはゲーム終了後・霊界 (公開状態) のみ。</li>
  <li>詳細は<a href="../spec.php#wolf_failed">詳細な仕様</a>参照。</li>
</ol>
...
<h3 id="tiger_wolf">虎狼 (占い結果：鬼 / 霊能結果：虎狼) [Ver. 3.0.0 α3～]</h3>
<pre>
...
<h4>[作成者からのコメント]</h4>
<pre>
<a href="#boss_wolf">白狼</a>の鬼判定バージョンです。
<a href="ogre.php">鬼陣営</a>出現時の占い師騙りの難易度を下げる事が狙いです。
</pre>
...
<h4>関連役職</h4>
<pre>
<a href="ability.php#cursed_group">呪い能力者</a>・<a href="ability.php#necromancer">特殊霊能判定能力者</a>
</pre>
<h4>[作成者からのコメント]</h4>
<pre>
...
<h4>関連役職</h4>
<pre>
<a href="human.php#telepath_scanner">念騒霊</a>・<a href="ability.php#talk_mind">発言閲覧能力者</a>
</pre>
<h4>[作成者からのコメント]</h4>
<pre>
...
<h3 id="eye_wolf">瞳狼 (占い結果：人狼 / 霊能結果：人狼) [Ver. 3.0.0 α6～]</h3>
<pre>
前日の<a href="wolf.php#wolf_eat_failed">人狼襲撃失敗</a>が分かる人狼。
死亡したら能力無効。
</pre>
<h4>関連役職</h4>
<pre>
...
<h4>[作成者からのコメント]</h4>
<pre>
<a href="human.php#eye_scanner">目目連</a>の人狼バージョンです。
本人が襲撃しなくても閲覧できるため、上位能力に属します。
そのまま<a href="human.php#eye_scanner">目目連</a>を騙ることもできますが、伏せたまま活かす方がより有効です。
</pre>
...
<h4>関連役職</h4>
<pre>
<a href="ability.php#position">位置能力者</a>・<a href="ability.php#authority">投票数変化能力者</a>
</pre>
<h4>[作成者からのコメント]</h4>
<pre>
...
<h4>[耐性] 封印：有効</h4>
<h4>[足音能力] タイプ：本人基点型 / キャンセル投票：特殊</h4>
<pre>
夜の投票時に自分と投票先の間で足音が鳴る人狼。
一度だけ、足音を鳴らさずに襲撃 (ステルス襲撃) できる。
</pre>
<h4>足音能力</h4>
<ol>
<li>身代わり君襲撃時は足音が鳴らない。</li>
<li>ステルス襲撃を行うと通り道に関係なく足音は鳴らなくなる。</li>
<li>能力を失う (<a href="sub_role.php#lost_ability">能力喪失</a>) とステルス襲撃を選択できなくなる。</li>
<li>ステルス襲撃は個別にカウントされる。</li>
</ol>
<h4>関連役職</h4>
<pre>
<a href="ability.php#step">足音能力者</a>・<a href="ability.php#seal">封印対象者</a>
</pre>
<h4>[作成者からのコメント]</h4>
<pre>
<a href="human.php#step_mage">審神者</a>の人狼バージョンです。
<a href="../game_option.php#step">足音村</a>の主役ですが、闇鍋モードの場合は襲撃役には不向きだと思われます。
</pre>
...
<h4>関連役職</h4>
<pre>
<a href="#emerald_wolf">翠狼</a>・<a href="ability.php#partner">仲間情報妨害能力者</a>
</pre>
<h4>[作成者からのコメント]</h4>
<pre>
ローゼンメイデンの蒼星石がモチーフです。
...
<h4>関連役職</h4>
<pre>
<a href="#blue_wolf">蒼狼</a>・<a href="ability.php#mind_friend">共鳴能力者</a>
</pre>
<h4>[作成者からのコメント]</h4>
<pre>
ローゼンメイデンの翠星石がモチーフです。
...
<h4>関連役職</h4>
<pre>
<a href="ability.php#last_words_decieve">遺言偽装能力者</a>
</pre>
<h4>[作成者からのコメント]</h4>
<pre>
...
<h4>関連役職</h4>
<pre>
<a href="ability.php#doom">死の宣告能力者</a>・<a href="ability.php#wolf_kill_avoid">人狼襲撃回避能力者</a>
</pre>
<h4>[作成者からのコメント]</h4>
<pre>
...
<h5>Ver. 1.4.0 β15～</h5>
<pre>
<a href="human.php#doll_rule_doll_master">人形遣い系</a>・<a href="chiroptera.php#boss_chiroptera">大蝙蝠</a>の身代わり能力適用
</pre>
<h4>関連役職</h4>
<pre>
<a href="ability.php#wolf_kill_avoid">人狼襲撃回避能力者</a>・<a href="ability.php#sex">性別関連能力者</a>
</pre>
<h4>[作成者からのコメント]</h4>
<pre>
...
<h3 id="honey_wolf">蜜狼 (占い結果：人狼 / 霊能結果：人狼) [Ver. 2.3.0 α5～]</h3>
<pre>
襲撃に成功したら自分も死亡してしまう人狼。
</pre>
<h4>自決能力</h4>
<ol>
<li><a href="../spec.php#dead_night">死因</a>は「自決したようです」。</li>
<li>妖狐を襲撃した場合も有効。</li>
<li>狼が残り一人だった場合は無効。</li>
<li><a href="sub_role.php#lovers">恋人</a>になったら無効。</li>
</ol>
<h4>[作成者からのコメント]</h4>
<pre>
名称はシグムンドの伝承が出展です。
遺言と組み合わせる事で毒死や呪殺に見せかける事が可能になります。
</pre>
...
<h4>関連役職</h4>
<pre>
<a href="ability.php#wolf_kill_avoid">人狼襲撃回避能力者</a>
</pre>
<h4>[作成者からのコメント]</h4>
<pre>
...
<pre>
<a href="#wolf_group">人狼系</a>と<a href="fox.php">妖狐カウント</a>しか噛み殺せない人狼。
</pre>
<h4>襲撃能力</h4>
<ol>
...
身代わり君・<a href="fox.php">妖狐陣営</a> (<a href="mania.php#unknown_mania_group">鵺系</a>・変化前の<a href="ability.php#copy_delay">コピー能力者 (時間差型)</a> を含む)・<a href="ability.php#possessed_limit">憑依制限能力者</a>は乗っ取れない。
</pre>
<h4>憑依能力</h4>
<ol>
...
例6-4) A[憑狼][恋人] → B[村人]、D[暗殺者] → C[<a href="lovers.php#self_cupid">求愛者</a>][恋人]
死体：B が無残な死体で発見されました (死因：「人狼に襲撃された」)
死体：C が無残な死体で発見されました (死因：「暗殺された」)
死体：A が恋人の後を追い自殺しました
憑依者が後追いが発生する場合は憑依が不成立になる。
</pre>

<h5>Ver. 2.2.1 / Ver. 2.3.0 α1～</h5>
<pre>
...
<h5>Ver. 1.4.0 β15～</h5>
<pre>
妖狐陣営に付いた<a href="mania.php#unknown_mania_group">鵺系</a>、<a href="fox.php">妖狐陣営</a>に変化前の<a href="ability.php#copy_delay">コピー能力者 (時間差型)</a> も憑依対象外に変更
</pre>
<h4>関連役職</h4>
<pre>
<a href="ability.php#possessed">憑依能力者</a>・<a href="ability.php#last_words_decieve">遺言偽装能力者</a>・<a href="ability.php#necromancer">特殊霊能判定能力者</a>
</pre>
<h4>[作成者からのコメント]</h4>
<pre>
長期人狼に実在する特殊狼です。
...
<h5>Ver. 1.4.0 β15～</h5>
<pre>
<a href="human.php#doll_rule_doll_master">人形遣い系</a>・<a href="chiroptera.php#boss_chiroptera">大蝙蝠</a>の身代わり能力無効
</pre>
<h5>Ver. 1.4.0 β13～</h5>
<pre>
...
<h4>関連役職</h4>
<pre>
<a href="mania.php#soul_mania">覚醒者</a>・<a href="ability.php#anti_assassin">暗殺耐性能力者</a>・<a href="ability.php#special_resist">特殊耐性能力者</a>・<a href="ability.php#resist_poison">毒耐性能力者</a>
</pre>
<h4>[作成者からのコメント]</h4>
<pre>
...
<pre>
<a href="fox.php#partner">妖狐陣営</a>から<a href="fox.php#child_fox_group">子狐</a>に、<a href="human.php#doll_rule">人形</a>から<a href="human.php#doll_rule_doll_master">人形遣い系</a>に見える人狼。
</pre>
<h5>Ver. 1.4.0 β21～</h5>
<pre>
...
<h4>関連役職</h4>
<pre>
<a href="ability.php#partner_silver">仲間情報妨害能力者</a>・<a href="ability.php#talk_mind">発言閲覧能力者</a>
</pre>
<h4>[作成者からのコメント]</h4>
<pre>
他国に実在する役職です。
...
<h4>関連役職</h4>
<pre>
<a href="mania.php#dummy_mania">夢語部</a>・<a href="ability.php#ogre_anti_wolf">鬼陣営/対人狼陣営型</a>・<a href="ability.php#win">追加勝利条件所持能力者</a>
</pre>
<h4>[作成者からのコメント]</h4>
<pre>
...
<h4>[作成者からのコメント]</h4>
<pre>
<a href="human.php#step_mage">審神者</a>の狂人バージョンで、「やなり」と読みます。
足音能力は存在を示すには便利ですが、効果的な騙りは難しいと思います。
</pre>

<h3 id="dream_eater_mad">獏 (占い結果：村人 / 霊能結果：村人) [Ver. 1.4.0 α21～]</h3>
<h4>[耐性] 狩り：有効</h4>
<pre>
夜に投票した人が<a href="ability.php#dummy">夢系能力者</a>か<a href="chiroptera.php#fairy_group">妖精系</a>なら殺す (夢食い) ことができる特殊な狂人。
<a href="human.php#dummy_poison">夢毒者</a>を処刑すると「毒」に中る。
...
<ol>
  <li>死因は「獏の餌食になった」。</li>
  <li><a href="mania.php#dummy_mania">夢語部</a>は変化前なら有効。</li>
  <li><a href="sub_role.php#vega_lovers">織姫</a>には無効。</li>
</ol>
<h5>Ver. 1.4.0 β9～</h5>
<pre>
<a href="human.php#dummy_poison">夢毒者</a>を処刑すると「毒」に中る (襲撃した場合は中らない)。
...
<h4>関連役職</h4>
<pre>
<a href="human.php#philosophy_wizard">賢者</a>・<a href="ability.php#vote_action">処刑投票能力者</a>・<a href="ability.php#critical_luck">痛恨能力者</a>・<a href="ability.php#luck">得票数変化能力者</a>
</pre>
<h4>[作成者からのコメント]</h4>
<pre>
...
<li><a href="quiz.php#quiz">出題者</a>・<a href="ability.php#special_resist">特殊耐性能力者</a>は能力の対象外。</li>
...
<h4>関連役職</h4>
<pre>
<a href="ability.php#mind_friend">共鳴能力者</a>・<a href="ability.php#revive">蘇生能力者</a>・<a href="ability.php#possessed_limit">憑依制限能力者</a>・<a href="ability.php#seal">封印対象者</a>
</pre>
<h4>[作成者からのコメント]</h4>
<pre>
