...
class VoteActionGroup {
  ...
  //夜投票初期化 / 一日目
  public static $init_first = array(
    VoteAction::MANIA,
    VoteAction::DUELIST
  );

  //夜投票初期化 / 二日目以降
  public static $init_after = array(
    VoteAction::GUARD,
  ...
  //足音 / 二日目以降
  public static $step_after = array(
    VoteAction::STEP_GUARD,
    VoteAction::STEP_ASSASSIN,
    VoteAction::STEP_VAMPIRE
  );
  ...
  //呪術
  public static $voodoo = array(
    VoteAction::VOODOO_MAD,
    VoteAction::VOODOO_FOX
  );

  //占い
  public static $mage = array(
    VoteAction::MAGE,
    VoteAction::CHILD_FOX,
    VoteAction::FAIRY,
    VoteAction::TENGU
