--------------------------------------------------------------------------------
  人狼式 ～汝は人狼なりや？式神エディション Version 5.0.1 README 2025/10/18
--------------------------------------------------------------------------------
...
4. message/ : 主にゲーム内のメッセージ設定ファイル置き場
...
Version 4.0.1:
・役割希望制：闇鍋モードの探偵村で探偵希望が機能していなかったバグ修正
・終了後の村のセッションクリア判定が正しくないバグ修正
・一部のゲームオプションを設定できないバグ修正
