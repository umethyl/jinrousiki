--------------------------------------------------------------------------------
  人狼式 ～汝は人狼なりや？式神エディション Version 5.0.3 README 2025/12/13
--------------------------------------------------------------------------------
...
A. MySQL サーバの設定、データベースの設定、ブラウザのエンコード、
   どれかが EUC-JP (ujis_japanese_ci) を使用していない可能性が高いです。
   一度チェックしてみてください。
   サーバによっては EUC-JP が使えない事があります。
   その場合はファイル自体の文字コードをサーバにあわせる必要があります。
   また、Ver. 1.4.0 β16 より、文字コードを ujis_japanese_ci から utf8_unicode_ci に変更しています。
...
------------
Version 5.0.3:
初期セットアップの変更処理が正しくないバグ修正
外部サーバー村稼働情報が取得できないバグ修正

Version 5.0.2:
アイコン一覧：「all」が機能していないバグ修正
入力文字コードを誤判定することがあるバグ修正

Version 5.0.1:
再投票発生時の処刑投票の表示順が正しくないことがあるバグ修正
「諜報員」「海歌姫」：1日目夜に投票できるバグ修正
