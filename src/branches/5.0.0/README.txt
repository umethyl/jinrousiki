--------------------------------------------------------------------------------
  人狼式 ～汝は人狼なりや？式神エディション Version 5.0.0 α1 README 2025/09/21
--------------------------------------------------------------------------------
...
9. 必要に応じてデザイン編集 (その他の情報一覧 → 管理者向け情報)
注：
...
--------------------------
  デバッグモードについて
--------------------------
ON にすることでいくつかの管理スクリプトが機能するようになり、一部の例外チェックがスキップされます。
...
https://osdn.jp/projects/jinrousiki/
...
なお、現在 OSDN/Sourceforge のページにフォーラムは用意されておりません。
OSDN/Sourceforge の方に報告される場合には、チケットを通してお願いいたします。
...
人狼式 ～汝は人狼なりや？式神エディション (OSDN/Sourceforgeプロジェクトページ)
https://osdn.jp/projects/jinrousiki/
