...
class VoteRoleMessage {
  ...
  public static $SERVANT_DO         = '対象を主にする';			//従者 (主選択)
  public static $SERVANT_END_DO     = '主を裏切る';			//従者 (裏切り)
  public static $SERVANT_END_NOT_DO = '主を裏切らない';			//従者 (裏切り/キャンセル)
