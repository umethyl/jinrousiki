...
class ChaosConfig {
  //-- 固定枠 --//
  //闇鍋
  public static $chaos_fix_role_list		= array('mage' => 1, 'wolf' => 1);

  //真・闇鍋
  public static $chaosfull_fix_role_list	= array('mage' => 1, 'wolf' => 1);

  //超・闇鍋
  public static $chaos_hyper_fix_role_list	= array('mage' => 1, 'wolf' => 1);

  //裏・闇鍋
  public static $chaos_verso_fix_role_list	= array();

  //-- 配役テーブル --//
  //人狼の最小出現枠 (役職名 => 出現比)
  //闇鍋
  public static $chaos_wolf_list = array(
    'wolf'        => 60,
    'boss_wolf'   =>  5,
    'poison_wolf' => 10,
    'tongue_wolf' =>  5,
  ...
  //真・闇鍋
  public static $chaosfull_wolf_list = array(
    'wolf'        => 60,
    'boss_wolf'   =>  5,
    'cursed_wolf' =>  5,
    'poison_wolf' =>  5,
  ...
  //超・闇鍋
  public static $chaos_hyper_wolf_list = array(
    'wolf'           => 15,
    'boss_wolf'      =>  1,
    'mist_wolf'      =>  2,
    'tiger_wolf'     =>  2,
  ...
  //妖狐の最小出現枠 (役職名 => 出現比)
  //闇鍋
  public static $chaos_fox_list = array(
    'fox'       => 90,
    'child_fox' => 10);

  //真・闇鍋
  public static $chaosfull_fox_list = array(
    'fox'        => 80,
    'white_fox'  =>  3,
    'poison_fox' =>  3,
    'voodoo_fox' =>  3,
  ...
  //超・闇鍋
  public static $chaos_hyper_fox_list = array(
    'fox'            => 18,
    'white_fox'      =>  2,
    'black_fox'      =>  2,
    'mist_fox'       =>  3,
  ...
  //ランダム配役テーブル (役職名 => 出現比)
  //闇鍋
  public static $chaos_random_role_list = array(
    'human'           => 88,
    'mage'            => 50,
    'soul_mage'       =>  5,
    'psycho_mage'     => 10,
  ...
  //真・闇鍋
  public static $chaosfull_random_role_list = array(
    'human'              =>  3,
    'suspect'            => 15,
    'unconscious'        => 20,
    'mage'               => 20,
  ...
  //超・闇鍋
  public static $chaos_hyper_random_role_list = array(
    'human'                 =>   1,
    'saint'                 =>  12,
    'executor'              =>   9,
    'elder'                 =>  20,
  ...
  //裏・闇鍋
  public static $chaos_verso_random_role_list = array(
    'human'       => 14,
    'mage'        => 10,
    'necromancer' => 10,
    'guard'       =>  5,
  ...
  //村人から振り返る役職 => 出現比
  //闇鍋
  public static $chaos_replace_human_role_list		= array('mania' => 1);

  //真・闇鍋
  public static $chaosfull_replace_human_role_list	= array('mania' => 7, 'unknown_mania' => 3);

  //超・闇鍋
  public static $chaos_hyper_replace_human_role_list	= array(
    'mania'            => 15,
    'trick_mania'      => 12,
    'basic_mania'      => 12,
    'scarlet_mania'    =>  9,
  ...
  public static $role_group_rate_list = array(
    CampGroup::MAGE         =>  6.2,
  ...
  */
  public static $topping_list = array(
    ...
    'l' => array('fix' => array(
		   ...
		   'silver_wolf'  => 1,
		   'howl_fox'     => 1)),
    'm' => array('fix'    => array('trap_wolf' => 1, 'doom_fox' => 1),
		 'random' => array(array('step_assassin' => 3, 'sweep_assassin' => 7)),
		 'count'  => array(2)),
    ...
    't' => array('random' => array(
			 ...
			 'eclipse_tengu' => 16)),
		 'count'  => array(1)),
    'u' => array('fix'    => array('fanatic_mad' => 1),
		 'random' => array(
                   array('depraver'           => 5,
			 'fire_depraver'      => 2,
  ...
  //サブ役職制限：EASYモード
  public static $chaos_sub_role_limit_easy_list = array(
  ...
  //サブ役職制限：NORMALモード
  public static $chaos_sub_role_limit_normal_list = array(
    'decide', 'plague', 'counter_decide', 'dropout', 'good_luck', 'bad_luck', 'authority',
    'reduce_voter', 'upper_voter', 'downer_voter', 'critical_voter', 'random_voter', 'rebel',
  ...
  //サブ役職制限：HARDモード
  public static $chaos_sub_role_limit_hard_list = array(
    'decide', 'plague', 'counter_decide', 'dropout', 'good_luck', 'bad_luck', 'authority',
    'reduce_voter', 'upper_voter', 'downer_voter', 'critical_voter', 'random_voter', 'rebel',
    'watcher', 'upper_luck', 'downer_luck', 'star', 'disfavor', 'critical_luck', 'random_luck',
