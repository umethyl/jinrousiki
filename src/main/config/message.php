...
class Message{
  ...
  public $common_talk = 'あーうー・・・あーうー・・・'; //共有者の囁き
  ...
  public $deadman            = 'は無残な負け犬の姿で発見されました';
  ...
  public $novoted            = 'はスキマ送りされました';
  public $chicken            = 'は小心者だったようです'; //小心者
  ...
  public $sudden_death_announce = '投票完了されない方はスキマ送りされてしまいます';
  //public $sudden_death_time = '突然死になるまで後：'; //突然死発動まで
  public $sudden_death_time = 'スキマ送りされるまで後：';
  //public $sudden_death = 'さんは突然お亡くなりになられました'; //突然死
  public $sudden_death = 'さんは紫に連れ去られました';
  ...
  public $gentleman_header = "お待ち下さい。\nあぁ……";  //紳士 (前半)
  public $gentleman_footer = '様の残り湯、美味にございます……。'; //紳士 (後半)
  //public $lady_header = "お待ちなさい！\n"; //淑女 (前半)
  //public $lady_footer = '、タイが曲がっていてよ。'; //淑女 (後半)
  public $lady_header = "こんなのがいいの！？\n"; //淑女 (前半)
  public $lady_footer = '！　そこに直って！　わたくしの足をなめなさい！！'; //淑女 (後半)
  ...
  public $chaos = '配役隠蔽モードだよ☆カオスを楽しんでね♪';
