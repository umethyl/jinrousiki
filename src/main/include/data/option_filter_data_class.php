...
//-- オプションフィルタデータベース --//
//-- ◆文字化け抑制◆ --//
class OptionFilterData {
  //追加役職
  public static $add_role = array(
