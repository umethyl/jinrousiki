...
final class RoleGroupSubData {
  ...
  public static $list = [
    ...
    'sudden-death' => ['chicken', 'critical_chicken', 'rabbit', 'perverseness', 'flattery',
		       'celibacy', 'nervy', 'androphobia', 'gynophobia', 'impatience', 'febris',
		       'chill_febris', 'frostbite', 'death_warrant', 'panelist', 'thorn_cross',
		       'infatuated'],
    ...
    'chiroptera'   => ['bad_status', 'sweet_status', 'male_status', 'female_status',
		       'gender_status'],
